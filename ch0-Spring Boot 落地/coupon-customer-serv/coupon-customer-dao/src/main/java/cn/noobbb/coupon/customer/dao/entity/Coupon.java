package cn.noobbb.coupon.customer.dao.entity;


import cn.noobbb.coupon.customer.api.enums.CouponStatus;
import cn.noobbb.coupon.customer.dao.convertor.CouponStatusConverter;
...
public class Coupon {
    ...
    /**
     * 冗余一个shop id方便查找       (为了应对高并发的场景，你必须尽可能提高系统的吞吐量和性能，以空间换时间)
     */
    @Column(name = "shop_id")
    private Long shopId;
