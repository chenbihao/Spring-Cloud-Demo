...
public class AntiPuaTemplate extends AbstractRuleTemplate{
    ...
    /**
     * 啥也不说了，下面的例子均为重度PUA的表现，以下名句均摘抄自某公司员工入职发放的本子
     * 1）因为相信，所以看见                  （解读：我画的饼在这，不管你信不信，反正我是信了）
     * 2）今天最好的表现，是明天最低的要求       （解读：卷到至死方休）
     * 3) 当你觉得不舒服的时候，就是成长的时候    （解读：对待PUA你要默默承受，我PUA你这是让你成长）
     * 4) 开会不能总讲和气，越和气就越微妙          （解读：鼓励大家向四面八方输出PUA文化）
     * 5) 生命在于折腾，不在折腾中崩溃，就在折腾中涅槃 （解读：公司文化在于PUA，不在PUA中崩溃离职，就在PUA中涅槃去PUA其他人）
     * <p>
     * PUA的精髓：
